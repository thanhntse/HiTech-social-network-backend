...
namespace HiTech.Service.GroupAPI.Migrations
{
    ...
    [Migration("20241001101001_GroupDatabaseV2")]
    partial class GroupDatabaseV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HiTech.Service.GroupAPI.Entities.JoinRequest", b =>
                {
            ...
            modelBuilder.Entity("HiTech.Service.GroupAPI.Entities.JoinRequest", b =>
                {
                    b.HasOne("HiTech.Service.GroupAPI.Entities.Group", "Group")
                        .WithMany("JoinRequests")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HiTech.Service.GroupAPI.Entities.User", "User")
                        .WithMany("JoinRequests")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
