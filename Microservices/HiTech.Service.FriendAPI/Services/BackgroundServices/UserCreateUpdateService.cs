...
namespace HiTech.Service.FriendAPI.Services.BackgroundServices
{
    public class UserCreateUpdateService : BackgroundService
    {
        ...
        {
            _messageConsumer.CreateConsumer(MessageQueueConstants.FRIENDSVC_USER_CREATE_UPDATE_QUEUE, async (model, ea) =>
            {
